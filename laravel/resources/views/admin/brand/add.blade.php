...
<form action="/admin/brandadds" method="post" enctype="multipart/form-data" id='fm'>
<!-- 正文区域 -->
                ...
                <div class="tab-pane active" id="home">
                    <div class="row data-type">
                        ...
                        <div class="col-md-10 data">
                            <input type="text" class="form-control" name="brand_name" id="brand_name"  ng-model="entity.name"  placeholder="品牌名称" value="">
                        </div>
                        ...
                        <div class="col-md-10 data">
                            <input type="text" id="url" ng-model="entity.name" name="url" class="form-control" placeholder="品牌地址" value="">
                        </div>
                    </div>
                </div>
