    ...
    <div class="box-body">
        ...
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="active">
                    <a href="#home" data-toggle="tab">配送方式信息</a>
                </li>
            </ul>
            <!--tab头/-->
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="home">
                    <div class="row data-type">
                        ...
                        <input type="hidden" name="mode_id" id="mode_id" value="{{$mode['id']}}">

                        <div class="col-md-2 title">配送方式</div>
                        <div class="col-md-10 data">
                            <input type="text" class="form-control" name="mode_name" id="mode_name"  ng-model="entity.name"  placeholder="配送方式" value="{{$mode['mode_name']}}">
                        </div>
...
<script>
    $(document).on('click','#add',function(){
        ...
        $.ajax({
            url: "{{'/admin/modeupdate'}}",
            type: 'post',
            data: {mode_name:mode_name,mode_id:mode_id},
            dataType: 'json',
