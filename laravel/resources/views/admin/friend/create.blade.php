    ...
    <div class="box-body">
        ...
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#home" data-toggle="tab">友情添加</a>
                </li>
            </ul>
            <!--tab头/-->
            <!--tab内容-->
                ...
                <div class="tab-pane active" id="home">
                    <div class="row data-type">
                        ...
                        <div class="col-md-10 data">
                            <input type="text" class="form-control" id="f_name" placeholder="盟友名称" value="">
                        </div>

                        <div class="col-md-2 title">盟友url</div>
                        <div class="col-md-10 data">
                            <input type="text" class="form-control" id="f_url" placeholder="盟友url" value="">
                        </div>
